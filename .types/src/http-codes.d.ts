export function isSuccessCode(status: any): boolean;
export function isRedirectionCode(status: any): boolean;
export function isClientErrorCode(status: any): boolean;
export function isServerErrorCode(status: any): boolean;
